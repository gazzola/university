...
\begin{tabular}{m{2cm}m{12.0cm}}
  ...
  % $s_c(V_i)$ & resultado da computação do vetor $V_i$ na rede neural para uma classe $c$ \\
...
Onde $\Upsilon$ denota o conjunto dos pares de palavras e classes gramaticais. Seguimos a ideia utilizada por \citeonline{fonseca2015evaluating} e computamos a equação acima utilizando uma operação \textit{softmax}:
