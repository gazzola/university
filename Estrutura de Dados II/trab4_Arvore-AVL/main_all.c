...
int main(){
    ...
    /* ARVORE PARA ROTACAO SIMPLES (NESSE CASO SERA A DIREITA)
	...
	*/
    ...
    /* ARVORE PARA ROTACAO DUPLA (NESSE CASO SERA A DIREITA SE REBALANCEADA APOS TODAS INSERCOES)
